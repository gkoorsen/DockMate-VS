...
> **On Windows (WSL)?** Follow the step-by-step student guide (Word document):
> [docs/SETUP_WSL.docx](docs/SETUP_WSL.docx) — from the Ubuntu shell to a
> running GUI. Regenerate it with `python scripts/make_wsl_setup_doc.py`.
